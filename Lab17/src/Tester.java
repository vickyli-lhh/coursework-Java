	...
	public static void main(String[] args) {
		...
		class LastListener implements ActionListener{			
			public void actionPerformed(ActionEvent e) {
				year.setText(Integer.toString(company.minusYear()));
				depreciation.setText(Double.toString(company.getDepreciation()));
				bookValue.setText(Double.toString(company.getBookValue()));
			}
		}
		
		class NextListener implements ActionListener{			
			public void actionPerformed(ActionEvent e) {
				year.setText(Integer.toString(company.addYear()));
				depreciation.setText(Double.toString(company.getDepreciation()));
				bookValue.setText(Double.toString(company.getBookValue()));
			}
		}
